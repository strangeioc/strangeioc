...
namespace babel.unittests
{
	...
	public class TestBinder
	{
		...
		public void TestNamedBinding ()
		{
			...
			binder.Bind<InjectableSuperClass>().To<InjectableDerivedClass> ().ToName("babel");
			...
			IBinding namedBinding2 = binder.GetBinding<InjectableSuperClass> ("babel");
			...
			Assert.That ((string)namedBinding2.name == "babel");
		}
