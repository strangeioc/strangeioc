The MultipleContexts example demonstrates how to build modular applications with Babel.

Inside this package are not one project but three, each of which is capable of running as
either a self-standing application or as part of an integrated whole. With Babel, you
