...
}]Exception raised when a View is mapped to itself. If a View is accidentally mapped to itself, the result will be an infinite loop of Mediation creation. \end{description}
\end{Desc}
